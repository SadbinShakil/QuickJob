  ...
  <div class="wrapper">
    <div class="sidebar">
      ...
      <ul>
        ...
        <li><a href="post_job2.php"><i class="fas fa-user"></i>Post Jobs</a></li>
        <li><a href="../employer_view.php"><i class="fas fa-user"></i>All Job Request</a></li>
        <li><a href=""><i class="fas fa-address-card"></i>Delete Jobs</a></li>
